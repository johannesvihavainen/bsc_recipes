      ...
      {activeSection === 'home' && (
        <section id='home'>
          <div className="recipes-container">
            ...
            <div className="prepping-guide-container prepping-guide-container-2">
              <div className="item-wrapper">
      ...
      {activeSection === 'prepping-guide' && (
        <div className="recipes-container">
          <div className="prepping-guide-container">
            ...
            <div className="item-wrapper">
              <p className="drink-title prepping">panasonic menu packaging guide</p>
              <img className='packaging-guide' src={packagingGuide2} alt="" />
            </div>

            <div className="item-wrapper">
              <p className="drink-title prepping">smoothie bowl packaging guide</p>
              <img className='packaging-guide' src={packagingGuide3} alt="" />
            </div>

            <div className="item-wrapper">
              <p className="drink-title prepping">norwegian brown cheese preparation</p>
              <img className='prepping-guide-cheese' src={preppingGuideCheese} alt="" />
            </div>

            <div className="item-wrapper">
              <p className="drink-title prepping">smoothie bowl topping formulas</p>
              <img className='smoothie-bowl-topping-formulas' src={toppingFormulas} alt="" />
            </div>
          </div>
        </div>
